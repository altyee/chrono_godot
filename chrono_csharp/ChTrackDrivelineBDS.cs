...
public class ChTrackDrivelineBDS : ChDrivelineTV {
  ...
  public override void LockDifferential(bool lock_) {
    vehiclePINVOKE.ChTrackDrivelineBDS_LockDifferential(swigCPtr, lock_);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override void Synchronize(double time, DriverInputs driver_inputs, double driveshaft_torque) {
    vehiclePINVOKE.ChTrackDrivelineBDS_Synchronize(swigCPtr, time, DriverInputs.getCPtr(driver_inputs), driveshaft_torque);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override void Disconnect() {
    vehiclePINVOKE.ChTrackDrivelineBDS_Disconnect(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public override double GetOutputDriveshaftSpeed() {
    double ret = vehiclePINVOKE.ChTrackDrivelineBDS_GetOutputDriveshaftSpeed(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
