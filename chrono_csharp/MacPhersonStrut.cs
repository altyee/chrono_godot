...
public class MacPhersonStrut : ChMacPhersonStrut {
  ...
  public virtual double getCamberAngle() {
    double ret = vehiclePINVOKE.MacPhersonStrut_getCamberAngle(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual double getToeAngle() {
    double ret = vehiclePINVOKE.MacPhersonStrut_getToeAngle(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual double getShockRestLength() {
    double ret = vehiclePINVOKE.MacPhersonStrut_getShockRestLength(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
