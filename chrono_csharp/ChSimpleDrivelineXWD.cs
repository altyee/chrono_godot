...
public class ChSimpleDrivelineXWD : ChDrivelineWV {
  ...
  public override void Synchronize(double time, DriverInputs driver_inputs, double driveshaft_torque) {
    vehiclePINVOKE.ChSimpleDrivelineXWD_Synchronize(swigCPtr, time, DriverInputs.getCPtr(driver_inputs), driveshaft_torque);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override double GetOutputDriveshaftSpeed() {
    double ret = vehiclePINVOKE.ChSimpleDrivelineXWD_GetOutputDriveshaftSpeed(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
