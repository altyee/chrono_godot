...
public class ChFunction_Setpoint : ChFunction {
  ...
  public override void ArchiveOut(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    if (SwigDerivedClassHasMethod("ArchiveOut", swigMethodTypes19)) corePINVOKE.ChFunction_Setpoint_ArchiveOutSwigExplicitChFunction_Setpoint(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive)); else corePINVOKE.ChFunction_Setpoint_ArchiveOut(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
