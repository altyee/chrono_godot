...
public class LinearSpringDamperForce : SpringForce {
  ...
  public LinearSpringDamperForce(double k, double c, double preload) : this(vehiclePINVOKE.new_LinearSpringDamperForce__SWIG_0(k, c, preload), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public LinearSpringDamperForce(double k, double c) : this(vehiclePINVOKE.new_LinearSpringDamperForce__SWIG_1(k, c), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
