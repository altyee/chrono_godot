...
public class ChNodeBase : global::System.IDisposable {
  ...
  public virtual int GetNdofX() {
    int ret = corePINVOKE.ChNodeBase_GetNdofX(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual int GetNdofW() {
    int ret = corePINVOKE.ChNodeBase_GetNdofW(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual int GetNdofX_active() {
    int ret = corePINVOKE.ChNodeBase_GetNdofX_active(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual int GetNdofW_active() {
    int ret = corePINVOKE.ChNodeBase_GetNdofW_active(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool UseFullDof() {
    bool ret = corePINVOKE.ChNodeBase_UseFullDof(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint NodeGetOffsetX() {
    uint ret = corePINVOKE.ChNodeBase_NodeGetOffsetX(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint NodeGetOffsetW() {
    uint ret = corePINVOKE.ChNodeBase_NodeGetOffsetW(swigCPtr);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void ArchiveOut(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    corePINVOKE.ChNodeBase_ArchiveOut(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
