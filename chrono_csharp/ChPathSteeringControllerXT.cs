...
public class ChPathSteeringControllerXT : ChSteeringController {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ChPathSteeringControllerXT obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ChPathSteeringControllerXT(ChBezierCurve path, double max_wheel_turn_angle) : this(vehiclePINVOKE.new_ChPathSteeringControllerXT__SWIG_0(ChBezierCurve.getCPtr(path), max_wheel_turn_angle), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public ChPathSteeringControllerXT(ChBezierCurve path) : this(vehiclePINVOKE.new_ChPathSteeringControllerXT__SWIG_1(ChBezierCurve.getCPtr(path)), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public ChPathSteeringControllerXT(string filename, ChBezierCurve path, double max_wheel_turn_angle) : this(vehiclePINVOKE.new_ChPathSteeringControllerXT__SWIG_2(filename, ChBezierCurve.getCPtr(path), max_wheel_turn_angle), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public ChPathSteeringControllerXT(string filename, ChBezierCurve path) : this(vehiclePINVOKE.new_ChPathSteeringControllerXT__SWIG_3(filename, ChBezierCurve.getCPtr(path)), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
