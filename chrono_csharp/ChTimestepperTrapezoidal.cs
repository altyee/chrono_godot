...
public class ChTimestepperTrapezoidal : ChTimestepperIIorder {
  ...
  public override void ArchiveOut(SWIGTYPE_p_chrono__ChArchiveOut archive) {
    corePINVOKE.ChTimestepperTrapezoidal_ArchiveOut(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(archive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void ArchiveIn(SWIGTYPE_p_chrono__ChArchiveIn archive) {
    corePINVOKE.ChTimestepperTrapezoidal_ArchiveIn(swigCPtr, SWIGTYPE_p_chrono__ChArchiveIn.getCPtr(archive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
