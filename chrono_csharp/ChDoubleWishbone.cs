...
public class ChDoubleWishbone : ChSuspension {
  ...
  public override SWIGTYPE_p_std__vectorT_chrono__vehicle__ChSuspension__ForceTSDA_t ReportSuspensionForce(VehicleSide side) {
    SWIGTYPE_p_std__vectorT_chrono__vehicle__ChSuspension__ForceTSDA_t ret = new SWIGTYPE_p_std__vectorT_chrono__vehicle__ChSuspension__ForceTSDA_t(vehiclePINVOKE.ChDoubleWishbone_ReportSuspensionForce(swigCPtr, (int)side), true);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
