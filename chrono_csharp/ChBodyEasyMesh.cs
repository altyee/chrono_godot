...
public class ChBodyEasyMesh : ChBodyAuxRef {
  ...
  public virtual void ArchiveOutConstructor(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    corePINVOKE.ChBodyEasyMesh_ArchiveOutConstructor(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public static SWIGTYPE_p_void ArchiveInConstructor(SWIGTYPE_p_chrono__ChArchiveIn marchive) {
    global::System.IntPtr cPtr = corePINVOKE.ChBodyEasyMesh_ArchiveInConstructor(SWIGTYPE_p_chrono__ChArchiveIn.getCPtr(marchive));
