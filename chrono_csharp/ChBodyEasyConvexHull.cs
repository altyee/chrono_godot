...
public class ChBodyEasyConvexHull : ChBody {
  ...
  public virtual void ArchiveOutConstructor(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    corePINVOKE.ChBodyEasyConvexHull_ArchiveOutConstructor(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public static SWIGTYPE_p_void ArchiveInConstructor(SWIGTYPE_p_chrono__ChArchiveIn marchive) {
    global::System.IntPtr cPtr = corePINVOKE.ChBodyEasyConvexHull_ArchiveInConstructor(SWIGTYPE_p_chrono__ChArchiveIn.getCPtr(marchive));
