...
public class ChTrackAssembly : ChPart {
  ...
  public uint GetNumTrackSuspensions() {
    uint ret = vehiclePINVOKE.ChTrackAssembly_GetNumTrackSuspensions(swigCPtr);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public ChTrackWheel GetIdlerWheel() {
    global::System.IntPtr cPtr = vehiclePINVOKE.ChTrackAssembly_GetIdlerWheel(swigCPtr);
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_chrono__vehicle__ChTrackSuspension_t_t GetTrackSuspensions() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_chrono__vehicle__ChTrackSuspension_t_t ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_chrono__vehicle__ChTrackSuspension_t_t(vehiclePINVOKE.ChTrackAssembly_GetTrackSuspensions(swigCPtr), false);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ChTrackSuspension GetTrackSuspension(uint id) {
    global::System.IntPtr cPtr = vehiclePINVOKE.ChTrackAssembly_GetTrackSuspension(swigCPtr, id);
  ...
  public ChTrackWheel GetRoller(uint id) {
    global::System.IntPtr cPtr = vehiclePINVOKE.ChTrackAssembly_GetRoller(swigCPtr, id);
    ChTrackWheel ret = (cPtr == global::System.IntPtr.Zero) ? null : new ChTrackWheel(cPtr, true);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void SetSuspensionVisualizationType(VisualizationType vis) {
    vehiclePINVOKE.ChTrackAssembly_SetSuspensionVisualizationType(swigCPtr, (int)vis);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetIdlerWheelVisualizationType(VisualizationType vis) {
    vehiclePINVOKE.ChTrackAssembly_SetIdlerWheelVisualizationType(swigCPtr, (int)vis);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
