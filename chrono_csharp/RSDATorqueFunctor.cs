...
public class RSDATorqueFunctor : global::System.IDisposable {
  ...
  public virtual double evaluate(double time, double rest_angle, double angle, double vel, ChLinkRSDA link) {
    double ret = (SwigDerivedClassHasMethod("evaluate", swigMethodTypes0) ? corePINVOKE.RSDATorqueFunctor_evaluateSwigExplicitRSDATorqueFunctor(swigCPtr, time, rest_angle, angle, vel, ChLinkRSDA.getCPtr(link)) : corePINVOKE.RSDATorqueFunctor_evaluate(swigCPtr, time, rest_angle, angle, vel, ChLinkRSDA.getCPtr(link)));
