...
public class ChCollisionModel : global::System.IDisposable {
  ...
  public virtual bool AddEllipsoid(ChMaterialSurface material, double axis_x, double axis_y, double axis_z, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddEllipsoid__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), axis_x, axis_y, axis_z, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddEllipsoid(ChMaterialSurface material, double axis_x, double axis_y, double axis_z, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddEllipsoid__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), axis_x, axis_y, axis_z, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddEllipsoid(ChMaterialSurface material, double axis_x, double axis_y, double axis_z) {
    bool ret = corePINVOKE.ChCollisionModel_AddEllipsoid__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), axis_x, axis_y, axis_z);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddBox(ChMaterialSurface material, double size_x, double size_y, double size_z, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddBox__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddBox(ChMaterialSurface material, double size_x, double size_y, double size_z, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddBox__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddBox(ChMaterialSurface material, double size_x, double size_y, double size_z) {
    bool ret = corePINVOKE.ChCollisionModel_AddBox__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylinder(ChMaterialSurface material, double radius, double height, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylinder__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylinder(ChMaterialSurface material, double radius, double height, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylinder__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylinder(ChMaterialSurface material, double radius, double height) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylinder__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool AddCylinder(ChMaterialSurface material, double radius, ChVectorD p1, ChVectorD p2) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylinder__SWIG_3(swigCPtr, ChMaterialSurface.getCPtr(material), radius, ChVectorD.getCPtr(p1), ChVectorD.getCPtr(p2));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylindricalShell(ChMaterialSurface material, double radius, double height, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylindricalShell__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylindricalShell(ChMaterialSurface material, double radius, double height, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylindricalShell__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCylindricalShell(ChMaterialSurface material, double radius, double height) {
    bool ret = corePINVOKE.ChCollisionModel_AddCylindricalShell__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCone(ChMaterialSurface material, double radius, double height, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddCone__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCone(ChMaterialSurface material, double radius, double height, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddCone__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCone(ChMaterialSurface material, double radius, double height) {
    bool ret = corePINVOKE.ChCollisionModel_AddCone__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCapsule(ChMaterialSurface material, double radius, double height, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddCapsule__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCapsule(ChMaterialSurface material, double radius, double height, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddCapsule__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddCapsule(ChMaterialSurface material, double radius, double height) {
    bool ret = corePINVOKE.ChCollisionModel_AddCapsule__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedBox(ChMaterialSurface material, double size_x, double size_y, double size_z, double sphere_r, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedBox__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z, sphere_r, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedBox(ChMaterialSurface material, double size_x, double size_y, double size_z, double sphere_r, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedBox__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z, sphere_r, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedBox(ChMaterialSurface material, double size_x, double size_y, double size_z, double sphere_r) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedBox__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), size_x, size_y, size_z, sphere_r);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedCylinder(ChMaterialSurface material, double radius, double height, double sphere_r, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedCylinder__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, sphere_r, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedCylinder(ChMaterialSurface material, double radius, double height, double sphere_r, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedCylinder__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, sphere_r, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddRoundedCylinder(ChMaterialSurface material, double radius, double height, double sphere_r) {
    bool ret = corePINVOKE.ChCollisionModel_AddRoundedCylinder__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), radius, height, sphere_r);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual bool AddBarrel(ChMaterialSurface material, double Y_low, double Y_high, double axis_vert, double axis_hor, double R_offset, ChVectorD pos, ChMatrix33D rot) {
    bool ret = corePINVOKE.ChCollisionModel_AddBarrel__SWIG_0(swigCPtr, ChMaterialSurface.getCPtr(material), Y_low, Y_high, axis_vert, axis_hor, R_offset, ChVectorD.getCPtr(pos), ChMatrix33D.getCPtr(rot));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddBarrel(ChMaterialSurface material, double Y_low, double Y_high, double axis_vert, double axis_hor, double R_offset, ChVectorD pos) {
    bool ret = corePINVOKE.ChCollisionModel_AddBarrel__SWIG_1(swigCPtr, ChMaterialSurface.getCPtr(material), Y_low, Y_high, axis_vert, axis_hor, R_offset, ChVectorD.getCPtr(pos));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool AddBarrel(ChMaterialSurface material, double Y_low, double Y_high, double axis_vert, double axis_hor, double R_offset) {
    bool ret = corePINVOKE.ChCollisionModel_AddBarrel__SWIG_2(swigCPtr, ChMaterialSurface.getCPtr(material), Y_low, Y_high, axis_vert, axis_hor, R_offset);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void ArchiveOut(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    corePINVOKE.ChCollisionModel_ArchiveOut(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
