...
public class ChTrackShoe : ChPart {
  ...
  public virtual SWIGTYPE_p_ChVehicleGeometry GetGroundContactGeometry() {
    SWIGTYPE_p_ChVehicleGeometry ret = new SWIGTYPE_p_ChVehicleGeometry(vehiclePINVOKE.ChTrackShoe_GetGroundContactGeometry(swigCPtr), true);
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
