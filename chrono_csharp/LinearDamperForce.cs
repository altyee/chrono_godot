...
public class LinearDamperForce : ForceFunctor {
  ...
  public LinearDamperForce(double c, double preload) : this(vehiclePINVOKE.new_LinearDamperForce__SWIG_0(c, preload), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public LinearDamperForce(double c) : this(vehiclePINVOKE.new_LinearDamperForce__SWIG_1(c), true) {
    if (vehiclePINVOKE.SWIGPendingException.Pending) throw vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
