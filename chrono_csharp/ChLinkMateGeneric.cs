...
public class ChLinkMateGeneric : ChLinkMate {
  ...
  public ChVectorD GetLagrangeMultiplier_f() {
    ChVectorD ret = new ChVectorD(corePINVOKE.ChLinkMateGeneric_GetLagrangeMultiplier_f(swigCPtr), true);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ChVectorD GetLagrangeMultiplier_m() {
    ChVectorD ret = new ChVectorD(corePINVOKE.ChLinkMateGeneric_GetLagrangeMultiplier_m(swigCPtr), true);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void SetUseTangentStiffness(bool useKc) {
    corePINVOKE.ChLinkMateGeneric_SetUseTangentStiffness(swigCPtr, useKc);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override void InjectKRMmatrices(SWIGTYPE_p_ChSystemDescriptor descriptor) {
    corePINVOKE.ChLinkMateGeneric_InjectKRMmatrices(swigCPtr, SWIGTYPE_p_ChSystemDescriptor.getCPtr(descriptor));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void KRMmatricesLoad(double Kfactor, double Rfactor, double Mfactor) {
    corePINVOKE.ChLinkMateGeneric_KRMmatricesLoad(swigCPtr, Kfactor, Rfactor, Mfactor);
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void ArchiveOut(SWIGTYPE_p_chrono__ChArchiveOut marchive) {
    corePINVOKE.ChLinkMateGeneric_ArchiveOut(swigCPtr, SWIGTYPE_p_chrono__ChArchiveOut.getCPtr(marchive));
    if (corePINVOKE.SWIGPendingException.Pending) throw corePINVOKE.SWIGPendingException.Retrieve();
  }
